...
export function printMyCats(){
    ...
    loaText.textContent = "2 år gammal silversköldpaddshona från Gårvikstassens uppfödning.";
    ...
    askeText.textContent = "1 år gammal svartsmokehane från Linnsan's uppfödning";
